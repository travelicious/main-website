    ...
    <body>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="col-md-6 col-md-blog">
                                                ...
                                                <div class="col-md-6">
                                                    <img src="<?php echo base_url(); ?>assets/frontend/images/mjb.png" class="img-responsive img-blog" alt="blog img" title="blog">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="cuadro_intro_hover " style="background-color:#cccccc;">
                                                    ...
                                                    <img src="<?php echo base_url(); ?>assets/frontend/images/news1.png" class="img-responsive" alt="blog news " title="blog title">
                            ...
                            <div class="carousel-inner">
                                <div class="item  active">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg1.jpg" class="img-responsive img-rounded">
                                                <div class="overlay"><h6>Kerala</h6><p>35% of</p></div>
                                            </a>

                                        </div>        
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg2.jpg" class="img-responsive img-rounded"> <div class="overlay">
                                                    <h6>Agra</h6><p>Starting from 13000</p></div></a>

                                        </div>
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg3.jpg" class="img-responsive img-rounded">
                                                <div class="overlay"> <h6>Rajsthan</h6><p>35% of</p></div>
                                            </a>

                                        </div>
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="images/pkg4.jpg" class="<?php echo base_url(); ?>assets/frontend/img-responsive img-rounded">
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg3.jpg" class="img-responsive img-rounded"></a>
                                            <div class="overlay"><h6>Delhi</h6> <p>50% OFF</p></div></a>
                                        </div>          
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg2.jpg" class="img-responsive img-rounded">  <div class="overlay">
                                        ...
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg4.jpg" class="img-responsive img-rounded">
                                                <div class="overlay"><h6>Agra</h6> <p>Starting from 13000</p></div>
                                            </a>

                                        </div>   
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="images/pkg1.jpg" class="<?php echo base_url(); ?>assets/frontend/img-responsive img-rounded">
                                ...
                                <div class="item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a class="" href="#"><img alt="" src="<?php echo base_url(); ?>assets/frontend/images/pkg2.jpg" class="img-responsive img-rounded"> <div class="overlay"><h6>Agra</h6><p>Starting from 13000</p></div></a>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog diologs">
                ...
                <!-- Modal content-->
                <form id="callback_request_formdata">
                    <div class="modal-content cust-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control fcf" name="req_name" id="req_name" placeholder="Enter Source point" required="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control fcf"  name="req_cit" id="req_cit" placeholder="Enter Source point" required="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control fcf" name="req_contact" id="req_contact" placeholder="Enter Source point" required="">
                        ...
                        <div class="modal-footer bt">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <button type="submit"  name="submit" class="btn btn-danger btn-lg btn-requ" data-toggle="modal" data-target="#thanks_modal" >
                                    <i class="fa fa-phone" aria-hidden="true"></i> Request A Call</button>
                            </div>
...
//            });
            ...
            $("#callback_request_formdata").submit(function (event) {

                event.preventDefault();
                var form = $('#callback_request_formdata');
                var url = '<?php echo site_url('admin/callback/save_callback_request_formdata') ?>';
