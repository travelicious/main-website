                    ...
                    <div class="container">
                        <section class="slider">
                            <div class="flexslider">
                                ...
                                <div class="flex-viewport" style="overflow: hidden; position: relative;"></div><ol class="flex-control-nav flex-control-paging"></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#">Previous</a></li><li><a class="flex-next" href="#">Next</a></li></ul></div>
                        </section>
                        <!--for circle-->    
            ...
            <div class="container-fluid wlc cont-fluid">
                ...
                <div class="row row-height">
                    <div class="col-md-12">
                        ...
                        <ul  class="breadcrumb short"><li><a href="#">Home</a></li><li class="active">Search Result</li></ul>
                        <ul  class="breadcrumb short">Short By: <li class="active">Trends News</li></ul>
                        <ul  class="breadcrumb short"><li class="active">Low | High</li></ul>    
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12 bdr-lft">
 ...
 <div class="form-group src-fg"> <input type="email" placeholder="Enter Your email id" class="from-control" name="enq_email" id="enq_emailstd<?php echo $values->id?>"></div>
    ...
    <button type="button" onclick="submit_qnqry(<?php echo $values->id?>);" class="btn bnt-Danger dgnr">Enquiry Now</button>
                    ...
                    <div class="panel-footer">
                                                ...
                                                <a class="btn icon-btn btn-muted" href="#"><span class="glyphicon btn-glyphicon fa fa-taxi img-circle text-muted"></span>Transfer</a>
                                                <a class="btn icon-btn btn-muted" href="#"><span class="glyphicon btn-glyphicon fa fa-cutlery img-circle text-muted"></span>Meals</a>
...
//            });
            ...
            function submit_qnqry(pak_id){
//                alert(pak_id);
                alert($("#name"+pak_id).val());
                
            }
//              $(function () {
//
//        $("#pack_enquiry").submit(function (event) {
//            
...
//                $.ajax({
//                    type: 'POST',
//                    url: "<?php echo base_url("admin/packages/enquiry_submit");?>",
//                    data: formData,
//                    cache: false,
//                    contentType: false,
//                    processData: false,
...
//                            var successmsg = '<div class="box-body">';
//                            successmsg += '<div class="alert alert-info alert-dismissable">';
//                            successmsg += '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>';
//                            successmsg += '<h4>	<i class="icon fa fa-check"></i> Info!</h4>';
//                            successmsg += msg;
//                            successmsg += '</div>';
//                            successmsg += '</div>';
//                            $('.successmsg').html(successmsg);
