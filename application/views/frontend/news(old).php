...
<body>
   ...
   <div class="row">
       <div class="col-md-3">
       <img src="<?php echo base_url();?>assets/images/logo.png" class="img-responsive logos" alt="logo" title="logo title">
       </div>
    <div class="col-md-3">
  ...
  <div class="container-fluid">
      ...
      <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
         <div class="panel panel-body pbody">
          <img src="<?php echo base_url();?>assets/images/news-left.jpg" class="img-responsive img-rounded" alt="" title=""> 
             <div class="caption">
...
ndard dummy text ever since the 1500s.
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
             ...
             <div class="panel panel-body pbody">
                 <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                 <img src="<?php echo base_url();?>assets/images/center-news.jpg" class="img-responsive img-rounded" alt="" tilte="" style="height: 89px;">
                     <div class="caption">
                     <h4><a href="#">City  News </a></h4>
                     </div>
                 </div>
                 <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                 <p>Place :<b>City name</b></p>
                 <p>Date :<b>1-06-2017</b></p>
                     <p class="new-para-news">ce the 1500s, when an unknown printer took a gall of 
type and scram bled it to make a type specimen booLo
m Ipsum is simply dummy text of the printing and type
tting industry.  </p>
                     <a href="" class="text-right text-danger readmore">Read More</a>
...
tting industry.  </p>
                ...
                <div class="panel panel-body pbody">
                 <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                 <img src="<?php echo base_url();?>assets/frontend/images/center-news.jpg" class="img-responsive img-rounded" alt="" tilte="" style="height: 89px;">
                     <div class="caption">
                     <h4><a href="#">City  News </a></h4>
                     </div>
                 </div>
                 <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                 <p>Place :<b>City name</b></p>
                 <p class="new-para-news">Date :<b>1-06-2017</b></p>
                     <p>ce the 1500s, when an unknown printer took a gall of 
type and scram bled it to make a type specimen booLo
m Ipsum is simply dummy text of the printing and type
tting industry.  </p>
                     <a href="" class="text-right text-danger readmore">Read More</a>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
             ...
             <div class="panel panel-body pbody">
                 <p class="right-side ">
                 <img src="images/center-news.jpg" class="img-responsive img-rounded" alt="" tilte="" style="height: 59px; width: 79px; display: inline-block;">
                 ce the 1500s, when an unknown p
rinter took a gall of type and sc
ram bled it to make a type specim
en booLom Ipsum is simply dummy
 text of the printing and typetti

                     
                     <a href="" class="text-right text-danger">Read More</a>
                     </p>
...
en booLom Ipsum is simply dummy
 text of the printing and typetti
ng industry.  this uis dummy text ce the 1500s, when an unknown p
...
en booLom Ipsum is simply dummy
 text of the printing and typetti
ng industry.  this uis dummy text ce the 1500s, when an unknown p.
                      this uis dummy text ce the 1500s, when an unknown p
                      this uis dummy text ce the 1500s... 
