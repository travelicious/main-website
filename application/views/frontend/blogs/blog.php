...
?>
                      ...
                      <img src="<?php echo base_url().'assets/images/'.$row->image; ?>" class="img-responsive img-news bdr-block" alt="news" title="news one">
                      ...
                      <h3 class="justifyclass blog-cus"><?php echo $title ?></h3>
                        ...
                        <p class="justifyclass blog-cus"><?php echo $description ?><a href="#">Read More >></a></p>
        ...
        ?>
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 demo">
                 ...
                 <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                      ...
                      <div class="col-md-12 blog-home-ing bdr-block">
                <img src="<?php echo base_url(); ?>assets/layouts/images/news1.jpg" class="img-responsive img-news bdr-block" alt="news" title="news one">
                    <div class="caption img-news ">
                    <h3 class="justifyclass blog-cus">Lorem Ipsum</h3>
                        <em class="cem">28 april,2017</em><em class="text-right">Author</em> 
                        <p class="justifyclass blog-cus">Lorem ipsum dolor amet tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum  aliqua adipiscing enim ad ipsum  elit sed eiusmod temLorem ipsum dolor amet tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum  elit sed eiusmod temLorem ipsum dolor amet tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum  elit sed eiusmod tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum dolor ametconsectetur aliqua enim ad ipsum dolor  adipiscing ealiqua enim ad minim.<a href="#">Read More >></a></p>
                ...
                <div class="col-md-12 blog-home-ing bdr-block">
                    ...
                    <h3 class="justifyclass blog-cus">Lorem Ipsum</h3>
                        <em class="cem">28 april,2017</em><em class="text-right">Author</em> 
                        <p class="justifyclass blog-cus"> amet  eiusmod tem aliqua adipiscing enim ad ipsum  elit sed Lorem ipsum dolor amet tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum  elit sed eiusmod tem aliqua enim  eiusmod tem aliqua enim  eiusmod tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad ipsum dolor ametconsectetur aliqua enim ad ipsum dolor  adipiscing ealiqua enim ad minim...<a href="#">Read More >></a></p>
                ...
                <img src="<?php echo base_url(); ?>assets/layouts/images/news1.jpg" class="img-responsive img-news bdr-block" alt="news" title="news one">
                    ...
                    <h3 class="justifyclass blog-cus">Lorem Ipsum</h3>
                        <em class="cem">28 april,2017</em><em class="text-right">Author</em> 
                        <p class="justifyclass blog-cus">Lorem ipsum dolor amet tem aliqua  tem aliqua adipiscing enim ad ipsum  elit sed eiusmod temLorem ipsum dolor amet tem aliqua enim ad ipsum dolor amet  eiusmod tem aliqua adipiscing enim ad eiusmod tem aliqua adipiscing enim ad eiusmod tem aliqua adipiscing enim ad ..<a href="#">Read More >></a></p>
