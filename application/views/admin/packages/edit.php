                    ...
                    <form>
                        ...
                        <div class="box box-block bg-white">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="Artisanal kale" id="package-url" name="package_url">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="package-meta-title" class="col-xs-2 col-form-label">Meta Title</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="tel" value="1-(555)-555-5555" id="package-meta-title" name="package_meta_title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="package-meta-description" class="col-xs-2 col-form-label">Meta Description</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="tel" value="1-(555)-555-5555" id="package-meta-description" name="package_meta_description">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="search" value="How do I shoot web" id="package-title" name="package_title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="package-image" class="col-xs-2 col-form-label">Package Image</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="file" value="bootstrap@example.com" id="package-image" name="package_image">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <textarea class="form-control" id="package-description" rows="3" name="package_description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="number" value="http://getbootstrap.com" id="example-url-input" name="package_duration">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="package-price" class="col-xs-2 col-form-label">Price</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="number" value="42" id="package-price">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10 text-md-right">
                                    <input class="btn btn-danger" type="submit" value="Add Package" >
                                </div>
                            </div>
